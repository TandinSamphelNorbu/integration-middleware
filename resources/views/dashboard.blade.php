...
@section('workspace')
            ...
            <section class="panel overflow-hidden">
                ...
                <form id="lookup-form" data-catalog-url="{{ route('dashboard.catalog') }}" data-fwa-url="{{ route('dashboard.fwa') }}" class="grid items-end gap-5 p-6 md:grid-cols-[1fr_1.4fr_1fr_auto]">
                    ...
                    <div id="type-field"><label class="field-label" for="subscriber-type">Subscriber type</label><select id="subscriber-type" name="type" class="field"><option value="prepaid">Prepaid</option><option value="postpaid">Postpaid</option></select></div>
